...
- Syren là một **tầng vật chất riêng, trung hòa điện-từ**: tác dụng qua rối twin và lực cơ học của [[WB_6_Sinh học#a) Mạch ma lực|mạch ma lực]], nên mọi hiệu ứng gói trong **nhiệt, lực cơ học, tạo hình**.

#### 2) Rối Syren

>Syren có hai dạng rối lượng tử nguyên thủy:
###### Rối cơ bản — lưới đa phần với toàn bộ twin

Mỗi hạt Syren ở vũ trụ này rối lượng tử đa phần với nhiều hạt twin ở các vùng vũ trụ xa khác trong vũ trụ Cấp I ở định nghĩa Syren trên — mỗi Hubble volume xa đó có thể chứa một Syrith-copy theo logic tổ hợp của Level I. Vì mỗi vùng vũ trụ xa tiến hóa độc lập với tốc độ thời gian địa phương khác nhau, các Syrith-copy đang ở các giai đoạn lịch sử khác nhau của riêng họ. Một hạt Syren = cửa sổ vào nhiều Syrith-copy đồng thời, có bao nhiêu thế giới có thể chứa twin thì hạt Syren mở ra bấy nhiêu kết nối.
...
- Syren-Hồi (Echo Form) là dạng thông tin hữu hình tạm thời, hình thành khi liên kết rối giữa Syren bên này và twin bên kia được **khuếch đại đủ mạnh** để **sao chép cấu trúc và lịch sử state của twin** lên một vật chứa Syren bên này (ví dụ: một cục đá)
...
> [[WB_6_Sinh học#a) Mạch ma lực|Mạch ma lực]] là dạng sợi pha trung gian dẫn năng lượng Syren. Khi sợi đan đủ mật độ và có vật chứa Syren làm anchor, mạng đan chuyển sang pha hồi — hữu hình hóa thông tin twin tạm thời thì trạng thái hữu hình hóa thông tin lúc này gọi là Syren hồi. 

**Đặc tính**:

- **Hữu hình**: chạm được, có khối lượng cảm nhận được, có thể tương tác vật lý ngắn ngủi.
...
- Syren hoạt động bằng cách hút nhiệt môi trường làm năng lượng, lấy thông tin rối twin rồi nắn thành Syren-Hồi có trật tự (mục 3 trên). Vì luôn hút nhiệt để nuôi cơ chế, Syren luôn lạnh 
- Syren hồi cũng cần hút năng lượng từ xung quanh để tồn tại và vì tính chất hút nhiệt nên nó cũng lạnh
...
- Năng lượng bị đẩy liên tục vào mạch ma lực găm vào cơ thể gây cho cơ thể chuyển biến xấu thông thường là ngộ độc năng lượng quá tải, ảo giác thông tin twin Syren, và tùy trạng thái cơ thể và sinh hóa cá thể mà triệu chứng khác nhau
	Khi bị mắc Veld, có rất ít **% cá thể có đột biến có lợi**
...
- Sau khi đồ ra bát, có **dưới 30 phút** để ăn xong (cho cả nóng và lạnh).
	Nồi chung = giữ được lâu hơn
- Nồi lớn giữ nóng được vài giờ → cả bàn ăn có thể múc dần.
### (Lõi Gaia ảnh hưởng) — Syren ~5%

| Nhiệt độ     | Hoạt tính                    | Hệ quả                                    |
| ------------ | ---------------------------- | ----------------------------------------- |
| Mọi nhiệt độ | Cực yếu hoặc không hoạt tính | An toàn — uống nước sông, tắm tự nhiên OK |
